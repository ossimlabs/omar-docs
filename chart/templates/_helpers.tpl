{{- define "omar-docs.imagePullSecret" }}
...
{{- define "omar-docs.volumeMounts.configmaps" -}}
...
{{- define "omar-docs.volumeMounts.pvcs" -}}
...
{{- define "omar-docs.volumeMounts" -}}
{{- include "omar-docs.volumeMounts.configmaps" . -}}
{{- include "omar-docs.volumeMounts.pvcs" . -}}
...
{{- define "omar-docs.volumes.configmaps" -}}
{{- range $configmapName, $configmapDict := .Values.configmaps}}
- name: {{ $configmapName | quote }}
  configMap:
    name: {{ $configmapName | quote }}
...
{{- define "omar-docs.volumes" -}}
{{- include "omar-docs.volumes.configmaps" . -}}
{{- include "omar-docs.volumes.pvcs" . -}}
